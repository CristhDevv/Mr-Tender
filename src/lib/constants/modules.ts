...
export const ALL_SYSTEM_MODULES: SystemModule[] = [
  ...
  },
  {
    ...
    description: 'Tablero Kanban de prospectos, etapas comerciales, links de pago Wompi/PSE y conversión a venta en 1 clic',
    defaultEnabled: true,
  ...
  {
    id: 'invoicing',
    name: 'Facturación & Documentos Comerciales',
    iconName: 'Receipt',
    group: 'base',
    categoryName: 'Facturación & Ventas',
    description: 'Emisión de facturas comerciales, comprobantes y documentos de venta',
  ...
  },
  {
    ...
    iconName: 'Briefcase',
    group: 'base',
    categoryName: 'Administración & Personal',
    description: 'Liquidación de salarios quincenal/mensual, deducciones de ley y colillas por WhatsApp',
    defaultEnabled: true,
    requires: ['employees']
  },
  {
