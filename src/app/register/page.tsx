          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
              <div>
                ...
                <select className="input-neu" value={form.country} onChange={e => { set('country')(e.target.value); set('currency')(e.target.value === 'CO' ? 'COP' : e.target.value === 'MX' ? 'MXN' : e.target.value === 'PE' ? 'PEN' : 'USD') }}>
