      ...
      try {
        ...
        if (data && data.length > 0) {
          ...
          setForm({
            ...
            ticketFooterMessage: row.ticket_footer_message || row.ticket_footer || '¡Gracias por su compra! Vuelva pronto.',
            ticketCopies: String(row.ticket_copies || '1'),
            nequiPhone: row.nequi_phone || row.whatsapp || row.phone || '',
            daviplataPhone: row.daviplata_phone || row.phone || '',
  ...
  async function handleSave() {
    ...
    try {
      const payload: Record<string, any> = {
        ...
        tax_regime: form.dianRegimen,
        ticket_footer: form.ticketFooterMessage,
        ticket_footer_message: form.ticketFooterMessage,
        ticket_copies: Number(form.ticketCopies) || 1,
        nequi_phone: form.nequiPhone,
        daviplata_phone: form.daviplataPhone,
