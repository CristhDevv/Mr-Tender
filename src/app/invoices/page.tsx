...
export default function InvoicesPage() {
  ...
  async function handleDownloadA4(inv: any) {
    ...
    await generateDianInvoicePdfA4(
      ...
      inv.qr_data || '',
      inv.dian_status === 'validated' ? 'Comprobante de Venta Aprobado' : 'Documento de Venta'
    )
  }
  ...
  return (
    <div style={{ maxWidth: 1200, margin: '0 auto', padding: '24px 16px', minHeight: '90vh' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 16, marginBottom: 24 }}>
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <div>
              <h1 style={{ fontSize: '1.6rem', fontWeight: 800, margin: 0, color: 'var(--text-primary)' }}>Historial de Facturación & Comprobantes</h1>
              <p style={{ margin: 0, color: 'var(--text-muted)', fontSize: '0.88rem' }}>
                Consulta, emisión interna y exportación de comprobantes y facturas de venta
              </p>
            </div>
          </div>
        </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 14, marginBottom: 24 }}>
        ...
        <div className="neu-card" style={{ padding: 18, borderRadius: 14, background: '#fff', border: '1px solid #E2E8F0' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', color: '#64748B', fontSize: '0.82rem', fontWeight: 600 }}>
            <span>COMPROBANTES VALIDADOS</span>
        ...
        <div>
          ...
          <div style={{ display: 'flex', gap: 12, marginBottom: 16, flexWrap: 'wrap' }}>
            ...
            >
              ...
              <option value="validated">Solo Aprobadas</option>
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.84rem' }}>
                <thead>
                  <tr style={{ background: '#F8FAFC', borderBottom: '1px solid #E2E8F0', textAlign: 'left', color: '#475569' }}>
                    ...
                    <th style={{ padding: '14px 16px', fontWeight: 700 }}>CLIENTE</th>
                    <th style={{ padding: '14px 16px', fontWeight: 700 }}>TOTAL</th>
                    <th style={{ padding: '14px 16px', fontWeight: 700 }}>ESTADO</th>
                    <th style={{ padding: '14px 16px', fontWeight: 700 }}>CÓDIGO / REF</th>
                        ...
                        <tr key={inv.id} style={{ borderBottom: '1px solid #F1F5F9', transition: 'background 0.15s' }}>
                          ...
                          <td style={{ padding: '14px 16px' }}>
                            ...
                            <div style={{ fontSize: '0.72rem', color: isCreditNote ? '#8B5CF6' : '#0284C7', fontWeight: 600 }}>
                              {isCreditNote ? 'Nota Crédito (91)' : 'Factura de Venta (01)'}
                            </div>
                          </td>
      ...
      {activeTab === 'new_invoice' && (
        <div className="neu-card" style={{ background: '#fff', borderRadius: 16, border: '1px solid #E2E8F0', padding: 24, maxWidth: 800, margin: '0 auto' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 20 }}>
            ...
            <h2 style={{ fontSize: '1.25rem', fontWeight: 800, margin: 0 }}>Emitir Factura de Venta</h2>
          </div>
          ...
          <form onSubmit={handleEmitManualInvoice}>
            ...
            <div style={{ background: '#F8FAFC', padding: 16, borderRadius: 12, border: '1px solid #E2E8F0', marginBottom: 20 }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 12 }}>
                ...
                <div>
                  <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 600, color: '#475569', marginBottom: 4 }}>Correo Electrónico del Cliente</label>
                  <input
                    type="email"
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end', gap: 10 }}>
              ...
              >
                ...
                {emittingManual ? 'Generando Factura...' : 'Emitir Factura de Venta'}
              </button>
            </div>
          </form>
        </div>
